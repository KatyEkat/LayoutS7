...
import Linkedin from "../../../asserts/img/SocialAbove/linkedin.svg";
import Youtube from "../../../asserts/img/SocialAbove/youtube.svg";

function SocialAboutProfile() {
  return (
    <S.SocialMediaBlock>
...
export default SocialAboutProfile;
